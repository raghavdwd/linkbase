...
/**
 * twitter redirect page that redirects to actual Twitter profile
 * @returns redirect page component
 */
export default function TwitterPage() {
  useEffect(() => {
    // Redirecting to actual Twitter profile
    window.location.href = "https://twitter.com/linkbase";
  }, []);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900">
      <div className="text-center">
        <h1 className="mb-4 text-2xl font-bold">Redirecting to Twitter...</h1>
        <p className="text-muted-foreground">
          You will be redirected to our Twitter profile shortly.
        </p>
        <div className="mt-4">
